<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="descBill.aspx.cs" Inherits="descBill" %>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="contentType1">
        <table style="margin-right:auto; margin-left:auto;">
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="closeBtn" runat="server" text="返回" OnClick="BtnClose_Click"/>
                    <asp:Button ID="saveBtn" runat="server" text="保存" OnClick="BtnSave_Click" ValidationGroup="ValidataGroup1"/>
                    <asp:Label ID="saveLbl" runat="server" Font-Size="Small" ForeColor="Red"></asp:Label>
                </td>
            </tr>
            <tr>
